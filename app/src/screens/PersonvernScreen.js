...
const s = StyleSheet.create({
  ...
  gdprText: { fontFamily: 'System', fontWeight: '500', fontSize: 12, color: '#7B8589', flex: 1, lineHeight: 17 },
  ...
  sheetTitle: { fontFamily: 'System', fontWeight: '800', fontSize: 20, color: '#111416', letterSpacing: -0.4, marginBottom: 10 },
  sheetBody: { fontFamily: 'System', fontWeight: '500', fontSize: 13, color: '#7B8589', textAlign: 'center', lineHeight: 20, marginBottom: 24 },
  ...
  policyText: { fontFamily: 'System', fontWeight: '400', fontSize: 13, color: '#2F3437', lineHeight: 22 },
});
